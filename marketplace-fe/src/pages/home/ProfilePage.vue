<template>
  <q-page class="q-my-lg">
    ...
    <div style="font-size: 12px">
      ...
      <div class="q-pa-sm q-py-md q-pl-md border" @click="navigateTo('home.alamat')">
        <p class="float-left">Edit Alamat</p>
        <p class="float-right"><q-icon name="location_on" size="20px" /></p>
        <br />
      </div>
